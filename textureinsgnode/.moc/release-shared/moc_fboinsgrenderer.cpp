...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FboInSGRenderer_t, stringdata) + ofs \
...
const QMetaObject FboInSGRenderer::staticMetaObject = {
    { &QQuickItem::staticMetaObject, qt_meta_stringdata_FboInSGRenderer.data,
      qt_meta_data_FboInSGRenderer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FboInSGRenderer.stringdata))
